package com.dlaca.service;

import com.dlaca.domain.Authority;
import com.dlaca.domain.User;
import com.dlaca.repository.AuthorityRepository;
...
import com.dlaca.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUserFake( String password, String firstName, String lastName, String email) {
        User newUser = new User();
        Authority authority = authorityRepository.findOne(AuthoritiesConstants.USER);
        Set<Authority> authorities = new HashSet<>();
        String encryptedPassword = passwordEncoder.encode(password);
